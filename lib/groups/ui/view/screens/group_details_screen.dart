                  ...
                  return [
                    BlocBuilder<GroupDetailsCubit, GroupDetailsState>(
                      ...
                      builder: (context, state) {
                        return AppSliverAppBar(title: state.group?.name ?? title, isLoading: state.isLoading || state.isRefreshing);
                      },
                    ),
                    SliverToBoxAdapter(
                                ...
                                style: theme.textTheme.displayMedium?.copyWith(
                                  color:
                                      group.balance == 0
                                          ...
                                          : (group.balance.isNegative ? theme.colorScheme.error : Colors.green),
                                ),
                              ),
                            ),
                          );
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListView.separated(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                  ...
                                                  children: [
                                                    SizedBox(
                                                      ...
                                                      child: CircularProgressIndicator(
                                                        value: state.memberDepositPercentage,
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      CurrencyInputFormatter.getFormatted(state.memberDeposit),
                                  ...
                                  separatorBuilder: (__, _) => const Gap(AppSpacing.s),
                                ),
                              ),
                            ],
                          );
